...
After deploying, get the FQDN of the https-frontend and browse to it and hit the `/hello` endpoint. It will call the gRPC backend (via gRPC) and return a message to the client.